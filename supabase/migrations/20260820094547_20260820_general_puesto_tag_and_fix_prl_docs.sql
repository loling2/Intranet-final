-- 1. Seed "General" puesto tag
INSERT INTO puesto_tags (nombre) VALUES ('General')
ON CONFLICT (nombre) DO NOTHING;

-- 2. Update get_my_prl_documents: treat "General" as visible to all employees with folder access
